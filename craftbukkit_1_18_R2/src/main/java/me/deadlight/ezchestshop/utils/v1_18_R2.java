...
public class v1_18_R2 extends VersionUtils {
    ...
    void openMenu(SignMenuFactory.Menu menu, Player player) {
        MenuOpener_v1_18_R2.openMenu(menu, player);
    }

    @Override
    public void injectConnection(Player player) {
        ((CraftPlayer) player).getHandle().b.a.m.pipeline().addBefore("packet_handler", "ecs_listener", new ChannelHandler_v1_18_R2(player));
    }
